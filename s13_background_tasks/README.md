...
参考章节：[`shareAI-lab/learn-claude-code/s13_background_tasks`](https://github.com/shareAI-lab/learn-claude-code/tree/main/s13_background_tasks)
